...
const config = createTamagui({
	...
	themes: {
		...
		blue: {
			...
			backgroundStrong: tokens.color.blue,
			backgroundTransparent: tokens.color.spaceBlueTransparent,
			backgroundHover: tokens.color.red,
			backgroundPress: tokens.color.green,
			backgroundFocus: tokens.color.yellow,

			borderColor: tokens.color.red,
			borderColorHover: tokens.color.red,
			borderColorPress: tokens.color.red,
			borderColorFocus: tokens.color.red,

			shadowColor: tokens.color.red,
			shadowColorHover: tokens.color.red,
			shadowColorPress: tokens.color.red,
			shadowColorFocus: tokens.color.red,
		},
		...
		green: {
			...
			backgroundStrong: tokens.color.blue,
			backgroundTransparent: tokens.color.spaceBlueTransparent,
			backgroundHover: tokens.color.yellow,
			backgroundPress: tokens.color.red,
			backgroundFocus: tokens.color.yellow,
